...
export const services: Service[] = [
  {
    ...
    description: "We support businesses and individuals in Ireland, the UK and Gibraltar with the recurring accounting and tax work that keeps obligations under control. That includes company accounts, tax returns, VAT and the practical preparation behind each filing.",
  ...
  },
  {
    ...
    description: "Our core markets are Ireland, the UK and Gibraltar. We also support clients in other jurisdictions, such as the UAE, on a case-by-case basis. Where several countries are involved, we help keep the accounting and reporting picture coherent and work alongside jurisdiction-specific specialists where their input is required.",
